...
public class AIPlayerMinimaxPruning extends AIPlayer {
 
   /** Constructor with the given game board */
   public AIPlayerMinimaxPruning(Board board) {
      super(board);
   }
   ...
   private int[] winningPatterns = {
         ...
         Integer.parseInt("000000111",2), // rows
   ...
   private boolean hasWon(Seed thePlayer) {
      int pattern = Integer.parseInt("000000000",2);  // 9-bit pattern for the 9 cells
      for (int row = 0; row < ROWS; ++row) {
         for (int col = 0; col < COLS; ++col) {
